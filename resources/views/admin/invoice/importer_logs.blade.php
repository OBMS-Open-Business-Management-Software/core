...
@section('content')
    <div class="container-fluid my-4">
        <div class="row">
            <div class="col-md-12">
                <a href="{{ route('admin.invoices.importers') }}" class="btn btn-outline-primary mb-3"><i class="bi bi-arrow-left-circle"></i> {{ __('Back to list') }}</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <i class="bi bi-list"></i> {{ __('Importer Log') }}
                    </div>
                    <div class="card-body">
