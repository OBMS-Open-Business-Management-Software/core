...
@section('content')
    <div class="container-fluid my-4">
        <div class="row">
            <div class="col-md-12">
                <a class="btn btn-primary float-right mb-4" data-toggle="modal" data-target="#add"><i class="bi bi-plus-circle"></i> {{ __('Create Customer') }}</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="customers" class="table mt-4 w-100">
                            <thead>
                            <tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="addLabel"><i class="bi bi-plus-circle"></i> {{ __('Create Customer') }}</h5>
                ...
                <form action="{{ route('admin.customers.create') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="suppress_welcome_email" class="col-md-4 col-form-label text-md-right">{{ __('Supress welcome email') }}</label>
