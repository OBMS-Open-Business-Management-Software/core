...
@section('content')
    <div class="container-fluid my-4">
        <div class="row">
            <div class="col-md-12">
                <a href="{{ route('admin.suppliers') }}" class="btn btn-outline-primary mb-4"><i class="bi bi-arrow-left-circle"></i> {{ __('Back to list') }}</a>
            ...
            <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <label class="font-weight-bold mb-0">{{ __('Account Balance:') }}</label> {{ number_format($user->prepaidAccountBalance, 2) }} €
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        ...
                        @else
                            ...
                            @endif
                            <label class="font-weight-bold mb-0">{{ __('Reverse Charge:') }}</label> {!! $user->reverse_charge ? '<span class="badge badge-success badge-pill">' . __('Applicable') . '</span>' : '<span class="badge badge-warning badge-pill">' . __('Not applicable') . '</span>' !!}<br>
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <i class="bi bi-list"></i> {{ __('Wire Transfer Transactions') }}
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.invoices.suppliers.add') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="reverse_charge" class="col-md-4 col-form-label text-md-right">{{ __('Reverse charge') }}</label>
